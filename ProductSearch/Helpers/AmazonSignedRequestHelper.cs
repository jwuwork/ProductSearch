...
namespace ProductSearch.Services
{
    class AmazonSignedRequestHelper
    {
         ...
         * http://aws.amazon.com
         * 
         * The region is the service end-point for your application:
         ...
         */
        public AmazonSignedRequestHelper(string awsAccessKeyId, string awsSecretKey, string awsAssociateTag, string region)
        {
            this.endPoint = region.ToLower();
